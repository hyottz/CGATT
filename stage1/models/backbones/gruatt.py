...
class GRUAttention(nn.Module):
    def __init__(self, in_channels=3, num_frames=25, hidden_dim=512, gru_layers=1):
        ...
        self.temporal_attention = TemporalAttentionModule(in_dim=hidden_dim*2)  # for Bi-GRU: in_dim=hidden_dim*2
        self.fc = nn.Linear(hidden_dim*2, 2048)  # Adjust according to the Bi-GRU output: hidden_dim*2
