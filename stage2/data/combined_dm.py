...
import torch
from torch.utils.data import DataLoader, DistributedSampler, RandomSampler, WeightedRandomSampler
...
class DataModule(LightningDataModule):
    ...
    def _dataloader(self, ds, drop_last=True, sampler=None, scale=1, shuffle=False):
        return DataLoader(
            ds,
    ...
    def train_dataloader(self):
        ...
        if not self.cfg.only_df:
            ...
            loaders.append(self._dataloader(train_ds, drop_last=True, scale=self.cfg.model.relative_bs))
        ...
        loaders.append(self._dataloader(dataset, drop_last=True))
        return loaders
    ...
    def val_dataloader(self):
        ...
        for ds_type in self.cfg.data.dataset_df.types_val:
            '''
            ds_type: Real, Deepfakes, FaceSwap, Face2Face, NeuralTextures, FaceShifter, DeeperForensics
            dataset_df.dst_type: c23
            ...
            ds = labeled_video_dataset_with_fix(
                ...
                # video_path_prefix: /home/taho/RealForensics/data/Forensics/{Real}/c23/cropped_faces
