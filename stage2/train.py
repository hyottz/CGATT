...
def main(cfg):
    ...
    if cfg.model.weights_filename:
        ...
        #)
        weights_path = os.path.join(get_original_cwd(), "stage2/weights", cfg.model.weights_filename)
        ...
        learner.model.backbone.load_state_dict(weights_student, strict=False)
        ...
        if not math.isclose(cfg.model.ssl_weight, 0.0):
            ...
            learner.model.target_encoder.load_state_dict(weights_teacher, strict=False)
